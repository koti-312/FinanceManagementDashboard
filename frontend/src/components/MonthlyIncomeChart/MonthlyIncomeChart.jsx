...
import "./MonthlyIncomeChart.css"

const MonthlyIncomeChart = ({ data }) => {
  return (
    <div className="monthly-income-card">

      <div className="monthly-income-header">
        <h3>Monthly Income</h3>
        <p>View your income for each month.</p>
      </div>
      <div className="monthly-income-chart">
        <ResponsiveContainer width="100%" height={380}>
          <BarChart data={data} barCategoryGap="10%" barGap={4}>
            ...
            />
            <Bar dataKey="income" name="Income" fill="#22c55e" radius={[6, 6, 0, 0]} barSize={38} />
          </BarChart>
        </ResponsiveContainer>
      </div>
